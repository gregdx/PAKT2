...
enum L10n {
    ...
    private static let strings: [String: String] = [
        ...
        "no_activities_found":  "No activities match your filters",
    ...
    private static let stringsFR: [String: String] = [
        "advanced_filters": "Filtres",
        "dur_short": "Court (<30m)", "dur_medium": "Moyen (30–90m)", "dur_long": "Long (>90m)",
        "duration": "Durée", "categories": "Catégories",
        "featured_only": "Coups de cœur",
        "reset_filters": "Réinitialiser", "apply_filters": "Appliquer",
        "search_activities": "Rechercher",
        "no_activities_found": "Aucune activité ne correspond à tes filtres",
