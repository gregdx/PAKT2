...
extension Venue {
    static let all: [Venue] = [
        Venue(name: "Le Flore",
              category: .cafe,
              address: "1 Pl. du 6 Juin 1944, 14000 Caen",
              distance: 0.8,
              rating: 4.5,
              reviewCount: 312,
              websiteURL: "https://www.leflore-caen.fr",
              gradient: [Color(red: 0.85, green: 0.65, blue: 0.45), Color(red: 0.65, green: 0.40, blue: 0.25)],
              icon: "cup.and.saucer.fill",
              tagline: "Coffee & brunch spot"),
        Venue(name: "Syncycle",
              category: .fitness,
              address: "15 Rue Écuyère, 14000 Caen",
              distance: 1.2,
              rating: 4.8,
              reviewCount: 187,
              websiteURL: "https://www.syncycle.fr",
        ...
        Venue(name: "Parc de la Colline aux Oiseaux",
              category: .outdoor,
              address: "Av. de l'Amiral Mountbatten, 14000 Caen",
              distance: 3.1,
              rating: 4.6,
              reviewCount: 524,
              websiteURL: "https://caen.fr/colline-aux-oiseaux",
              gradient: [Color(red: 0.15, green: 0.45, blue: 0.25), Color(red: 0.08, green: 0.30, blue: 0.18)],
              icon: "leaf.fill",
              tagline: "Park · Run · Walk"),
        Venue(name: "L'Orange Bleue",
              category: .fitness,
              address: "2 Rue Daniel Huet, 14000 Caen",
              distance: 1.5,
              rating: 4.2,
              reviewCount: 203,
              websiteURL: "https://www.lorangebleue.fr",
              gradient: [Color(red: 0.90, green: 0.50, blue: 0.15), Color(red: 0.75, green: 0.30, blue: 0.10)],
              icon: "dumbbell.fill",
              tagline: "Gym & fitness"),
        Venue(name: "Hippodrome de Caen",
              category: .sport,
              address: "Bd Yves Guillou, 14000 Caen",
              distance: 4.2,
              rating: 4.3,
              reviewCount: 98,
              websiteURL: "https://www.hippodrome-caen.fr",
              gradient: [Color(red: 0.25, green: 0.35, blue: 0.55), Color(red: 0.15, green: 0.20, blue: 0.40)],
              icon: "sportscourt.fill",
              tagline: "Running track · Open air"),
        Venue(name: "Spa Serenity",
              category: .wellness,
              address: "8 Rue Saint-Jean, 14000 Caen",
              distance: 0.6,
              rating: 4.7,
              reviewCount: 156,
              websiteURL: "https://www.spa-serenity-caen.fr",
              gradient: [Color(red: 0.55, green: 0.40, blue: 0.60), Color(red: 0.35, green: 0.22, blue: 0.45)],
              icon: "sparkles",
              tagline: "Spa · Sauna · Massage"),
    ]
}
